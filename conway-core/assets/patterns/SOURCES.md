...
| 파일 | 내용 | 원본 |
|---|---|---|
| `clock_pm.rle` | 실제 시각을 표시하는 디지털 시계 (10016×6796) | 기존 프로젝트 파일 |
...
| `memory_tape.rle` | 구성기용 메모리 테이프 (Dave Greene) | Golly `Patterns/Life/Signal-Circuitry/constructor-memory-tape.rle` |
